...
<head>
<meta charset="UTF-8">
<title>Student Attendance History Page</title>
...
<body>
      ...
      <div id="b1">
       ...
       <%
        String sem =(String)session.getAttribute("S_emester");
        String did = (String)session.getAttribute("DeptId");
        int sid[] = (int[])session.getAttribute("srr");
        String fname[] = (String[])session.getAttribute("Frname");
        String lname[] = (String[])session.getAttribute("Lrname");
     ...
     %>
      ...
      <% 
        ...
        int totalClass = (int)session.getAttribute("TotalClass");
        int attendClass[] = (int[])session.getAttribute("AttendClass");
        int percentage[] = (int[])session.getAttribute("Percentage");
     %> 
     ...
     <div id="p" > <b> Department ID : <%= did %> </b> </div>    
            ...
            <div id="p4"> 
              <a href="attendanceHistory.jsp"><button id="button1">Back</button></a>
