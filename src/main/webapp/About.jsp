...
<body>
      ...
      <div id="d1">
      <p id="p1"> Actually it is a simple Attendance Management System web app where any College and University
            can use this system and is specially design for University or College </p>
      <p id="p1"> This app is basically design for Computer or laptop screen not for mobile screen
                  , if you use laptop or computer that is useful for you </p>
      <p id="p1"> We want your review and rating for further update please give your effective opinion bellow,
                   </p> 
      </div>             
