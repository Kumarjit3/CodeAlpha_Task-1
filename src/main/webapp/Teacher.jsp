    ...
    <div id="b1">
     ...
     <div id="d2">
        ...
        <div id="d2_1">
          ...
          <label id="l1"> Teacher Login </label>
          
          <form action="TeacherLogin">
          
          <div id="d2_2">
          
             <label id="l2"> Enter Your Email Id : </label> <br> 
             <input type="email" name="email" placeholder="Email Id">
             
             <br> <br>
             
             <label id="l3"> Enter Your Password : </label> <br>
             <input type="password" name="upass" placeholder="Password">
             
             <br> <br>
             
             <label id="l4"> Enter Your Private Key : </label> <br>
             <input type="password" name="key" placeholder="Private Key">
